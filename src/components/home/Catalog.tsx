...
function ProductCard({ product, index }: { product: Product; index: number }) {
  ...
  return (
    ...
    >
      <div className="relative mb-3.5 flex aspect-square items-end bg-green-medium p-[18px] transition-opacity group-hover:opacity-95 group-focus-visible:ring-2 group-focus-visible:ring-ochre group-focus-visible:ring-offset-2">
